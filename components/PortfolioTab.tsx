...
import {
  Briefcase, ArrowLeftRight, Check, Trash
} from 'lucide-react';
import { SavedAssessment, PropertyConfig, RentalStrategy, MarketInsight } from '../types';
...
interface PortfolioTabProps {
  ...
  togglePropertyForComparison: (id: string) => void;
  setShowComparisonModal: (v: boolean) => void;
  deleteSaved: (id: string) => void;
  // Load saved analysis handlers
  setPropertyInput: (v: string) => void;
  setDisplayedAddress: (v: string) => void;
  setStrategy: (s: RentalStrategy) => void;
  setBaseConfig: (c: PropertyConfig) => void;
  setSelectedAmenityIds: (ids: string[]) => void;
  setInsight: (i: MarketInsight) => void;
  setActiveTab: (tab: any) => void;
}

const PortfolioTab: React.FC<PortfolioTabProps> = ({
  savedAssessments, comparisonMode, toggleComparisonMode,
  selectedForComparison, togglePropertyForComparison,
  setShowComparisonModal, deleteSaved,
  setPropertyInput, setDisplayedAddress, setStrategy,
  setBaseConfig, setSelectedAmenityIds, setInsight, setActiveTab
}) => {
  return (
