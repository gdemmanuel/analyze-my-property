-- =============================================================================
-- RentCast API Response Cache (SAFE VERSION - No DROP statements)
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_rentcast_cache_key ON rentcast_cache(cache_key);

-- Expiration cleanup index
CREATE INDEX IF NOT EXISTS idx_rentcast_cache_expires ON rentcast_cache(expires_at);

-- Analytics indexes
CREATE INDEX IF NOT EXISTS idx_rentcast_cache_endpoint ON rentcast_cache(endpoint);
CREATE INDEX IF NOT EXISTS idx_rentcast_cache_created ON rentcast_cache(created_at DESC);

-- Composite index for popular properties
CREATE INDEX IF NOT EXISTS idx_rentcast_cache_hits ON rentcast_cache(hit_count DESC, last_accessed_at DESC);
...
-- SELECT * FROM rentcast_cache LIMIT 1;
-- SELECT * FROM get_rentcast_cache_stats();

-- =============================================================================
-- DONE! Table and functions created successfully
-- =============================================================================
